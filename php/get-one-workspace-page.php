...
function getOneWorkspacePage($availableDistricts, $isNewUser) {
    $availableDistricts = explode(",", $availableDistricts);
    // for($i = 0; $i < count($availableDistricts); $i++) {
    //     $a += "<p>".$availableDistricts[$i]."</p>";
    // }
    ...
    //     $districtList += "<li".$active."><a href='#'>".$availableDistricts[$i]."</a></li>";
    // }
    ...
    //     <body>
    //         <div class='wrapper'>
    //             <div class='header__close' onclick = '
    //                 document.querySelector(\'.header__open\').style.display = \'block\';
    //             '>
    ...
    //                     <div>
    //                         <div class='mini-map'>
    //                             <img src='img/mini-map-cfo.jpg' alt='Карта ЦФО'>
    //                         </div>
    //                         <div class='nav-bottom'>
    //                             <ul class='menu'>  
    //                                 <li class='user-menu'>
    //                                     <div class='burger-button-wrapper' onclick = '
    //                                         document.querySelector(\'.header__open\').style.display = \'none\';
    //                                     '>
    //                                         <div class='burger-button'></div>
    //                                     </div>
    ...
    //                                         document.querySelector(\'.header__open\').style.display = \'none\';
    //                                     '></div>
    //                                     <div class='user-menu-item' onClick = 'document.querySelector(\'nav\').classList.toggle(\'submenu-open\');'>
    //                                         <h1 class='not-header'>ЦФО</h1>
    //                                         <ul class='submenu'>".
    //                                         $districtList.
    ...
    //                         <img src='img/map_0.png' alt='Карта' onclick = '
    //                             fullScreenFunction();
    ...
    //                 </div>
    //             </main>
    //             <div class='params__close' onclick = '
    //                 document.querySelector(\'.params__open\').style.display = \'block\';
    //             '>
    //                 <div>Параметры</div>
    //             </div>
    ...
    //                         <h2>Параметры</h2>
    //                         <div class='close' onclick = '
    //                             document.querySelector(\'.params__open\').style.display = \'none\';
    //                         '></div>
    //                     </div>
